...
<html lang="en">
  ...
  <body>
    <div
      ...
      data-ws-url="{escape(ws_url)}"
      data-detail-base-url="{escape(detail_base_url)}"
      data-overview-url="{escape(overview_url)}"
      data-sessions-url="{escape(sessions_url)}"
      data-jobs-url="{escape(jobs_url)}"
      data-archives-url="{escape(archives_url)}"
      data-evaluations-url="{escape(evaluations_url)}"
      data-scenarios-url="{escape(scenarios_url)}"
    >
      <header class="hero">
