"""Session summary builder — extracted from EvaluationService._build_summary."""
...
def build_summary(
    *,
    ...
    quality_samples = _build_output_quality_samples(turn_records)
    quality_summary = _build_output_quality_summary(quality_samples)
